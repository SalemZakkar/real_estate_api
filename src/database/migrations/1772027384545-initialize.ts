...
export class Initialize1772027384545 implements MigrationInterface {
    name = 'Initialize1772027384545'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."property_category_enum" AS ENUM('buy', 'rent', 'swap')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."property_status_enum" AS ENUM('unCompleted', 'pending', 'rejected', 'active', 'unactive')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."otp_reason_enum" AS ENUM('Login')`);
        await queryRunner.query(`CREATE TYPE "public"."otp_channel_enum" AS ENUM('phone')`);
